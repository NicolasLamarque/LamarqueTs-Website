      ...
      <div class="space-y-6">
        ...
        >
          ...
          <div v-if="showLinks && index === 0" class="mt-5 flex flex-col sm:flex-row gap-3">
            ...
            >
              <font-awesome-icon :icon="['fas', 'stethoscope']" class="w-4 h-4" />
            ...
            <a
              ...
              class="flex items-center justify-center gap-2 bg-sky-600 text-white px-5 py-3 rounded-xl shadow hover:bg-sky-700 transition"
            >
              <font-awesome-icon :icon="['fas', 'user-doctor']" class="w-4 h-4" />
...
const etapes = [
  {
    ...
    points: [
      ...
      "Attention aux délais : Bien qu'elle soit gratuite, l'évaluation par le biais du secteur public peut être longue (parfois plusieurs mois)."
    ]
  },
  {
